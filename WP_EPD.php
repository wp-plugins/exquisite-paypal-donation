...
<div class=wrap>
    ...
    <div style="background: none repeat scroll 0 0 #ECECEC;border: 1px solid #CFCFCF;color: #363636;margin: 10px 0 15px;padding:15px;text-shadow: 1px 1px #FFFFFF;">
        <?php _e('Check our web page for more information and live examples: ')?><a href="http://www.dream-scape.net/plugins/exq" target="_blank" >Exquisite PayPal Donation</a><br/>
        <?php _e('Your input, comments, suggestions and requests for support are most welcome: ')?> <a href="http://www.dream-scape.net/plugins/contact" target="_blank" >contact us</a>
    </div>
